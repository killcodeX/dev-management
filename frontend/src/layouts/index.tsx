...
export default function Menu() {
  ...
  useEffect(() => {
    if (width < 700) {
      document.documentElement.style.setProperty("--appside-bar-width", "0rem");
      setAsideClose(true);
    } else {
  ...
  return (
    <div className="app-menu">
      {width > 700 ? (
        <Aside asideClose={asideClose} setAsideClose={setAsideClose} />
      ) : (
        <MobileAside mobileMenu={mobileMenu} setMobileMenu={setMobileMenu} />
      )}
